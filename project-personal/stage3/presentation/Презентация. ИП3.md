...
![Стандартный список паролей](image/1.PNG){#fig:001 width=70%}
...
![Расширение для браузера](image/3.PNG){#fig:003 width=40%}
